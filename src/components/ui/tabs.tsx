...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-center rounded-base border-2 border-border dark:border-darkBorder bg-main dark:bg-darkMain p-1 text-black",
      className
    )}
    {...props}
  />
